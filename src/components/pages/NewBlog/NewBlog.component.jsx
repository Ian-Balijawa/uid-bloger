...
import availableBlogs from '../../../data/blogs.json';

const NewBlog = () => {
	const [blogs, setBlogs] = useState(availableBlogs.blogs);
	...
	const handleSubmit = (e) => {
		...
		// 		axios
		// 			.post(
		// 				process.env.REACT_APP_BACKEND + '/blogs/new',
		// 				blogData,
		// 				options
		// 			)
		// 			.then(() => {
